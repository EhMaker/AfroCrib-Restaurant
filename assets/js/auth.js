...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!window.supabase || typeof window.supabase.createClient !== "function") {
    console.error(
      '⚠️ Supabase SDK not found. Add <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script> before this file.',
    );
    return;
  }
...
class AuthFlow {
  ...
  attachEventListeners() {
    ...
    // Success step
    this.exploreMenuBtn?.addEventListener("click", () =>
  ...
  async handleResendCode() {
    ...
    try {
      ...
      this.verificationCode.parentNode.insertBefore(
        successMsg,
        this.verificationCode.nextSibling,
      );
  ...
  handleExploreMenu() {
    ...
    window.location.href = (window.SITE_PAGES || "") + "shop.html";
  }
